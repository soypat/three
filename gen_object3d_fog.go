...
func (obj Fog) GetWorldPosition(target Vector3) Vector3 {
	return Vector3{
...
func (obj Fog) GetWorldDirection(target Vector3) Vector3 {
	return Vector3{
...
func (obj Fog) GetWorldScale(target Vector3) Vector3 {
	return Vector3{
...
func (obj Fog) GetWorldQuaternion(target Quaternion) Quaternion {
	return Quaternion{
		Value: obj.Call("getWorldDirection", target.Value),
	}
}
