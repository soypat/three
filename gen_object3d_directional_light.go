...
func (obj DirectionalLight) Copy(m Object3D, recursive bool) DirectionalLight {
	return DirectionalLight{Value: obj.Value.Call("copy", m.getInternalObject(), recursive)}
}

func (obj DirectionalLight) Clone(recursive bool) DirectionalLight {
	return DirectionalLight{Value: obj.Value.Call("clone", recursive)}
}
...
func (obj DirectionalLight) GetWorldPosition(target Vector3) Vector3 {
	return Vector3{
...
func (obj DirectionalLight) GetWorldDirection(target Vector3) Vector3 {
	return Vector3{
...
func (obj DirectionalLight) GetWorldScale(target Vector3) Vector3 {
	return Vector3{
...
func (obj DirectionalLight) GetWorldQuaternion(target Quaternion) Quaternion {
	return Quaternion{
		Value: obj.Call("getWorldDirection", target.Value),
	}
}
