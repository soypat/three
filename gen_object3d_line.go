...
func (obj Line) Copy(m Object3D, recursive bool) Line {
	return Line{Value: obj.Value.Call("copy", m.getInternalObject(), recursive)}
}

func (obj Line) Clone(recursive bool) Line {
	return Line{Value: obj.Value.Call("clone", recursive)}
}
...
func (obj Line) GetWorldPosition(target Vector3) Vector3 {
	return Vector3{
...
func (obj Line) GetWorldDirection(target Vector3) Vector3 {
	return Vector3{
...
func (obj Line) GetWorldScale(target Vector3) Vector3 {
	return Vector3{
...
func (obj Line) GetWorldQuaternion(target Quaternion) Quaternion {
	return Quaternion{
		Value: obj.Call("getWorldDirection", target.Value),
	}
}
