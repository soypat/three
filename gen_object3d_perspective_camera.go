...
// object3d_method_generator -typeName PerspectiveCamera -typeSlug perspective_camera

import "syscall/js"

// Compile-time check that this type implements Object3D interface.
var _ Object3D = PerspectiveCamera{}
...
func (obj PerspectiveCamera) Copy(m Object3D, recursive bool) PerspectiveCamera {
	return PerspectiveCamera{Value: obj.Value.Call("copy", m.getInternalObject(), recursive)}
}

func (obj PerspectiveCamera) Clone(recursive bool) PerspectiveCamera {
	return PerspectiveCamera{Value: obj.Value.Call("clone", recursive)}
}
...
func (obj PerspectiveCamera) GetWorldPosition(target Vector3) Vector3 {
	return Vector3{
...
func (obj PerspectiveCamera) GetWorldScale(target Vector3) Vector3 {
	return Vector3{
...
func (obj PerspectiveCamera) GetWorldQuaternion(target Quaternion) Quaternion {
	return Quaternion{
		Value: obj.Call("getWorldDirection", target.Value),
	}
}
