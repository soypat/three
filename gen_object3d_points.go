...
func (obj Points) GetWorldPosition(target Vector3) Vector3 {
	return Vector3{
...
func (obj Points) GetWorldDirection(target Vector3) Vector3 {
	return Vector3{
...
func (obj Points) GetWorldScale(target Vector3) Vector3 {
	return Vector3{
...
func (obj Points) GetWorldQuaternion(target Quaternion) Quaternion {
	return Quaternion{
		Value: obj.Call("getWorldDirection", target.Value),
	}
}
