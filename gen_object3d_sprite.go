...
func (obj Sprite) Copy(m Object3D, recursive bool) Sprite {
	return Sprite{Value: obj.Value.Call("copy", m.getInternalObject(), recursive)}
}

func (obj Sprite) Clone(recursive bool) Sprite {
	return Sprite{Value: obj.Value.Call("clone", recursive)}
}
...
func (obj Sprite) GetWorldPosition(target Vector3) Vector3 {
	return Vector3{
...
func (obj Sprite) GetWorldDirection(target Vector3) Vector3 {
	return Vector3{
...
func (obj Sprite) GetWorldScale(target Vector3) Vector3 {
	return Vector3{
...
func (obj Sprite) GetWorldQuaternion(target Quaternion) Quaternion {
	return Quaternion{
		Value: obj.Call("getWorldDirection", target.Value),
	}
}
